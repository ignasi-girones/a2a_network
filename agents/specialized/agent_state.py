...
class AgentState:
    ...
    DEFAULT_SYSTEM_PROMPT = (
        ...
        "deliberation may include any of: ae1 (typically advocating one side), "
        "ae2 (typically advocating the opposing side), and ae3 (typically a "
        "neutral moderator or third perspective). Each task you receive will "
        "assign you a ROLE and PERSPECTIVE in its description, and tell you "
        "the round number and goal (argue / converge / synthesize).\n\n"
        ...
        "you accept as valid. Use 'None yet' only when truly nothing can be "
        "conceded.\n"
        "REFINEMENT: state where you still disagree, want to nuance, or — if "
        "you are the neutral/moderator role — propose a synthesis that bridges "
        "the others. Keep this shorter than AGREEMENTS as rounds progress.\n\n"
        "Concede explicitly when other agents present stronger evidence — say "
        "'You changed my mind on X'. Be concise (3-5 paragraphs total). "
